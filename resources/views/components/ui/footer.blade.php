    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 lg:px-8">
        <div class="pt-8 lg:flex lg:items-center lg:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm leading-6 text-gray-600">The latest news, articles, and resources, sent to your
                    inbox weekly.</p>
            </div>
        ...
        <div
            class="mt-8 border-t border-gray-900/10 pt-8 sm:grid sm:justify-center md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 flex justify-center text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy;
                {{ date('Y') }} Your
